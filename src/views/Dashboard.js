  ...
  return (
    <>
      <Container fluid>
        <Row>
          <Col lg="3" sm="6">
            <Card className="card-stats shadows">
              <Card.Body>
                <Row>
                  <Col xs="5">
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category text-warning">New Booked</p>
              ...
              <Card.Footer>
                ...
                >
                  <i className="fas fa-redo mr-1 text-warning"></i>
                  Latest Update
                </div>
              </Card.Footer>
            </Card>
          ...
          <Col lg="3" sm="6">
            <Card className="card-stats shadows">
              ...
              <Card.Footer>
                <hr></hr>
                <div className="stats text-success" role="button">
            ...
            <Card className="card-stats shadows">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category text-danger">
                        Pick up in Progress
                      </p>
              ...
              <Card.Footer>
                <hr></hr>
                <div className="stats text-danger" role="button">
                  <i className="nc-icon nc-watch-time mr-1 text-danger"></i>
                  In the last hour
                </div>
              </Card.Footer>
            </Card>
            ...
            <Card className="card-stats shadows">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category text-success">Delivered</p>
                      <Card.Title as="h4">220</Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
          ...
          <Col lg="3" sm="6">
            <Card className="card-stats shadows">
                ...
                <Row>
                  <Col xs="5">
                    <div className="icon-big text-center icon-warning">
                      ...
                      {/* <i class="fa-light fa-person-biking-mountain"></i> */}
                    </div>
                  </Col>
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category text-info">Rider Active</p>
              ...
              <Card.Footer>
                <hr></hr>
                <div className="stats text-info" role="button">
                  <i className="fas fa-redo mr-1"></i>
                  Update now
                </div>
              </Card.Footer>
            ...
            <Card className="card-stats shadows">
              <Card.Body>
                <Row>
                  <Col xs="5">
                    <div className="icon-big text-center icon-warning">
                      <i className="nc-icon nc-notification-70 text-primary"></i>
                    </div>
                  </Col>
                  <Col xs="7">
                    <div className="numbers">
              ...
              <Card.Footer>
                <hr></hr>
                <div className="stats text-primary" role="button">
                  <i className="fas fa-redo mr-1"></i>
                  Update now
                </div>
              </Card.Footer>
            ...
            <Card className="card-stats shadows">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category text-warning">Returned</p>
              ...
              <Card.Footer>
                <hr></hr>
                <div className="stats text-warning" role="button">
                  <i className="fas fa-redo mr-1"></i>
                  Update now
                </div>
              </Card.Footer>
            ...
            <Card className="card-stats shadows">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category text-success">
                        Parcel Received
                      </p>
                      <Card.Title as="h4" className="text-success">
                        10
        ...
        <Row>
          <Col md="12">
            <Card>
              <Card.Header>
                <Card.Title as="h4">Weekly Sales</Card.Title>
              </Card.Header>
              <Card.Body>
                <div className="ct-chart" id="chartHours">
                  <ChartistGraph
                    data={{
                      ...
                      series: [
                        [1500, 1950, 2300, 2600, 1200, 3000, 1800, 2200, 2795],
                        [200, 600, 300, 120, 2500, 600, 400, 1207],
                      ],
                    }}
                    type="Line"
                    options={{
              ...
              <Card.Footer>
                <div className="legend">
                  ...
                  Delevierd <i className="fas fa-circle text-danger"></i>
                  Returned
                </div>
                <hr></hr>
                <div className="stats">
